...
ppt资料请转至[About Me](/guide/connect-me#email)联系博主获取
...
将Nginx作为反向代理服务器，我们访问[百度](www.baidu.com)时，反向代理服务器会将我们的访问请求转发到真实的服务器上。所以，方向代理隐藏了真实的服务器地址信息。从我们（客户端）的角度看，并不知道我们刚才访问的其实是代理服务器。
...
即将客户端的请求分发到多个服务器上，从而提高服务器的并发能力。
